...
const CreateTwit = (props) => {
    ...
    const handleTweetSubmit = (e) => {
        ...
        if(authData){
            ...
            axios.post('http://localhost:9002/tweets', {content: tweetContent}, headers)
            .then((res) => {
        ...
        <div className="row create-twit">
            ...
            <div className="col-sm">
                <form onSubmit={handleTweetSubmit}>
                    <div>
                        <textarea className='text-area-create-twit' placeholder='Whats happening ?' required='required' onChange={handleTweetContentChange} value={tweetContent} />
                    </div>
                    <div>
